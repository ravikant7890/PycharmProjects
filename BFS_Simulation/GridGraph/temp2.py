...
# igraph.Lattice(2, nei=1, directed=False, mutual=True, circular=True)
...
# result=g.shortest_paths_dijkstra(source=0, target=None, weights=None, mode=OUT)
#
# print result

'''
Script to perform bfs simulation on regular 3D grid
Arguments :
1. lenght of side for grid
2. number of partitions
3. number of simulations to be performed with hash partitioning
4. folder where results going to be stored (need not to exist)
'''
...
#################Visualization#############################
    ...
    # plot(g, layout = layout)
#############run bfs################
center=int(math.floor( m/2)*(m*m*m)+ math.floor( m/2)*(m*m)+ math.floor( m/2)*m+ math.floor( m/2))
