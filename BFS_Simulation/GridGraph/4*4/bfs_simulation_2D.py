...
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_util_2D.pdf")
plt.close()
####################plot internode#####################
fig=plt.gcf()
# fig.set_size_inches(20.5, 15.5)
...
plt.xticks([1,250,500,750,1001],('0','250','500','750','1000'))
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_internodeMSG_2D.pdf")
plt.close()
# # #
# # # ####################plot intranode#####################
#
...
plt.xticks([1,250,500,750,1001],('0','250','500','750','1000'))
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_intranodeMSG_2D.pdf")
