...
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_util_4D.pdf")
plt.close()
####################plot internode#####################
fig=plt.gcf()
# fig.set_size_inches(25.5, 15.5)
...
plt.yticks([50000,100000,150000,200000,250000,300000,350000,400000],('50','100','150','200','250','300','350','400'))
plt.xticks([1,13,26,39,52,65],('0','13','26','39','52','64'))
# plt.savefig(parent_folder+"/InterNode.pdf")
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_internodeMSG_4D.pdf")
plt.close()
# # #
# # # ####################plot intranode#####################
#
...
plt.yticks([5000,10000,15000,20000,25000],('5','10','15','20','25'))

# plt.savefig(parent_folder+"/intra.pdf")
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_intranodeMSG_4D.pdf")