...
#############run bfs################
center=int(math.floor( m/2)*n*n+math.floor( m/2)*n+math.floor( n/2))#FIXME:changes on dimesion
...
[0, 1, 4, 16, 5, 17, 20, 21],
[2, 3, 6, 18, 7, 19, 22, 23],
[8, 9, 12, 24, 13, 25, 28, 29],
[10, 11, 14, 26, 15, 27, 30, 31],
[32, 33, 36, 48, 37, 49, 52, 53],
[34, 35, 38, 50, 39, 51, 54, 55],
[40, 41, 44, 56, 45, 57, 60, 61],
[42, 43, 46, 58, 47, 59, 62, 63]]
...
max_ss= 3*int(math.floor(m/2))#FIXME: changes on dimension
