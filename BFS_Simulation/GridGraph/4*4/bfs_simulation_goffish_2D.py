...
g = Graph.Lattice([m,m],directed=True, circular=False)
...
#############run bfs################
center=int(math.floor( m/2)*n+math.floor( m/2))  ###centre calculation
...
print "number of ss required "+str(max_ss)
...
##############################################################################################################
    ...
    for ss in range(0,max_ss+1):
        ...
        # print "superstep "+str(ss)+" time "+ss_time
...
# plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_util_fp_2D.pdf")
plt.close()
####################plot internode#####################
fig=plt.gcf()
# fig.set_size_inches(20.5, 15.5)
...
bp=plt.boxplot(internode_communication)
for box in bp['boxes']:
# change outline color
    box.set( color='k', linewidth=3)
for cap in bp['whiskers']:
...
# plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_internodeMSG_fp_2D.pdf")
plt.close()
# # #
# # # ####################plot intranode#####################
#
...
bp=plt.boxplot(intranode_communication)
for box in bp['boxes']:
# change outline color
    box.set( color='k', linewidth=3)
for cap in bp['whiskers']:
...
# plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_intranodeMSG_fp_2D.pdf")
