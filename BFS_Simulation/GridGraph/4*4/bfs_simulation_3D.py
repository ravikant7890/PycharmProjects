...
#############run bfs################
center=int(math.floor( m/2)*n*n+math.floor( m/2)*n+math.floor( m/2))#FIXME:Change in case of dimension change
...
max_ss= 3* int(math.floor(n/2))#FIXME:change in case of dimension change
...
for z in range(number_of_simulations):
    ...
    for i in range(0,int(Graph.vcount(g)),1):
        s.add(i)
...
# plt.show()
plt.xticks([1,30,60,90,120,151],('0','30','60','90','120','150'))

# plt.xt(['0','250','500','750','1000'])

# plt.savefig(parent_folder+"/util.pdf")
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_util_3D.pdf")
plt.close()
####################plot internode#####################
fig=plt.gcf()
...
plt.xlabel('Superstep')
plt.ylabel('Internode Message Count(*1000)')
...
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_internodeMSG_3D.pdf")
plt.close()
# # #
# # # ####################plot intranode#####################
#
...
plt.grid()
plt.xlabel('Superstep')
plt.ylabel('Intranode Message Count(*1000)')
...
plt.savefig("/home/ravikant/mysvn/europar-2016_x/latex/figures/bfs_intranodeMSG_3D.pdf")