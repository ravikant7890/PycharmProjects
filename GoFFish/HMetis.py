...
def metis_command(inputPath, numPartitions1, numPartitions2):
    ...
    orkut_for_vornoi="/scratch/ipdpsw-hpbdc-2016/ORKT-4Blogel-5D/Vornoi-input.txt"
    ...
    copy_to_hdfs_command="hadoop dfs -copyFromLocal /scratch/ipdpsw-hpbdc-2016/ORKT-4Blogel-5D/Vornoi-input.txt /user/gofs/Blogel-graphs/Metis2Blogel-ORKT10D/"
    ...
    run_vornoi_command="mpiexec -n 40 $HOME/hashmin/run"
    ...
    copy_from_hdfs_command="hadoop dfs -copyToLocal /user/gofs/VornoiPartitioned-graphs/6-2-2016/ORKT-5D/part*  /scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/"
    ...
    os.system(' cat /scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/part* >/scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/ORKT_5P-Vornoi')

    os.system('awk \'{ print $1, $3 }\' /scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/ORKT_5P-Vornoi |sort -k1 -n |awk \'{print $2}\' >> /scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/ORKT_5P-Vornoi.part.5')
    ...
    os.system("mv \"/scratch/ipdpsw-hpbdc-2016/VornoiPartitioned-5D/ORKT_5P-Vornoi.part.5\"  "+partitionPath)
