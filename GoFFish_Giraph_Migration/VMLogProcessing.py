...
for filename in out_dir_list:
    ...
    # exit()
    '''for FFD'''
    command_for_Default_FFD_FFDwithMigration="python /home/ravikant/PycharmProjects/GoFFish_Giraph_Migration/VMFFD.py "+simulation_folder+"/"+filename+" "+source_partition+" "+no_of_partitions+" "+partition_size+" "+SERIALIZATION_TIME+" "+DESERIALIZATION_TIME
    ...
    #
    # command_for_MinMax="python /home/ravikant/PycharmProjects/GoFFish_Giraph_Migration/VMMinMax.py "+simulation_folder+"/"+filename+" "+source_partition+" "+no_of_partitions+"  10 "+max_constraint+" "+default_makspan+" "+partition_size +" "+SERIALIZATION_TIME+" "+DESERIALIZATION_TIME
    #
    #
    ...
    #     command_for_MinMax="python /home/ravikant/PycharmProjects/GoFFish_Giraph_Migration/VMMinMax.py "+simulation_folder+"/"+filename+" "+source_partition+" "+no_of_partitions+"  "+min_constraint+" "+max_constraint+" "+default_makspan+" "+partition_size +" "+SERIALIZATION_TIME+" "+DESERIALIZATION_TIME
    #     # print "executing command ",command_for_MinMax
    #
    #     result = subprocess.check_output(command_for_MinMax, shell=True)
    #     outcome= result.split("\n")
...
######################################################################
    ''' for ffdmp'''
    #
    # command_for_FFD_LossGainVMIncrement="python /home/ravikant/PycharmProjects/GoFFish_Giraph_Migration/VMFFDMP.py "+simulation_folder+"/"+filename+" "+source_partition+" "+no_of_partitions+" "+constraint+" "+default_makspan+" "+partition_size +" "+SERIALIZATION_TIME+" "+DESERIALIZATION_TIME
    #
    #
    # # print "executing command ",command_for_FFD_LossGainVMIncrement
    #
