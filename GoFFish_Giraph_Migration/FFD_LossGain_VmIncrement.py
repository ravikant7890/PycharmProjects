...
if __name__ == '__main__':
    ...
    if (len(sys.argv)!=7):
        print "Usage FDD_with_LossGain.py file_name source_partition number_of_partitions constraint_val DEFAULT_MAKESPAN partition_size"
        print "Example:"
        print "FDD_with_LossGain.py test.csv 4 40 20 20000 50.5"
